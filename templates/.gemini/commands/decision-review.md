<!-- AUTO-GENERATED from .gemini/skills/decision-review/SKILL.md -->
---
...
This command invokes the `decision-review` skill. See the skill documentation for detailed process steps.

## Skill Reference

This command invokes: `@skills/decision-review`

See `.gemini/skills/decision-review/SKILL.md` and `.gemini/skills/decision-review/reference.md` for full documentation.
